...
const Register = ()=>{
  ...
  <div class="mb-3">
    ...
    <input type="Text" class="form-control"  onChange={(e)=>setContact(e.target.value)}/>
    <p>{contact}</p>
  </div>
  ...
  <input type="radio" class="btn-check" name="btnradio" id="btnradio1" value='Male' onChange={(e)=>setGender(e.target.value)} autocomplete="off"/>
  <label class="btn btn-outline-primary" for="btnradio1">Male</label>

  <input type="radio" class="btn-check" name="btnradio" id="btnradio2" value='Female' onChange={(e)=>setGender(e.target.value)} autocomplete="off"/>
